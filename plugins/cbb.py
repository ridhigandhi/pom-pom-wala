...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "about":
        await query.message.edit_text(
                        text = f"<b>○ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/cultured_stars'>ᴄᴜʟᴛᴜʀᴇᴅ ꜱᴛᴀʀꜱ</a>\n○ ʟᴀɴɢᴜᴀɢᴇ : <code>ᴘʏᴛʜᴏɴ3</code>\n○ ꜱᴜᴘᴘᴏʀᴛ : <a href='https://t.me/cultured_starsbot'>ᴄᴜʟᴛᴜʀᴇᴅ ꜱᴛᴀʀꜱ ꜱᴜᴘᴘᴏʀᴛ</a>\n○ ꜱᴇʀᴠᴇʀ : <a href='https://www.heroku.com/'>ʜᴇʀᴏᴋᴜ</a></a>",
